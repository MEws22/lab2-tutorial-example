...
public class TutorialSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (name=ID material=Material shape=Shape color=Color markers+=Marker*)
	 * </pre>
	 */
	 ...
	 *
	 * Constraint:
	 *     (componentA=[Component|ID] markerA=[Marker|EString] componentB=[Component|ID] markerB=[Marker|EString])
	 * </pre>
	 */
	protected void sequence_ItemConnection(ISerializationContext context, ItemConnection semanticObject) {
		...
		feeder.accept(grammarAccess.getItemConnectionAccess().getMarkerAMarkerEStringParserRuleCall_2_0_1(), semanticObject.eGet(TutorialPackage.Literals.ITEM_CONNECTION__MARKER_A, false));
		...
		feeder.accept(grammarAccess.getItemConnectionAccess().getMarkerBMarkerEStringParserRuleCall_7_0_1(), semanticObject.eGet(TutorialPackage.Literals.ITEM_CONNECTION__MARKER_B, false));
		feeder.finish();
	}
